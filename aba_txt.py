...
# Nodal parameters
TOTAL_FORCE = 200 * BREAK_A * (number_of_nodes - 2*BREAK_A)
...
def create_connector(
    ...
    connector_elasticity_dir1 = ConnectorElasticity(
        behavior=behavior_1,
        coupling=coupling_1,
        components=components_1,
        table=force_displacement_table_1,
        dependencies = 0
    )

    connector_elasticity_dir2 = ConnectorElasticity(
        behavior=behavior_2,
        coupling=coupling_2,
        components=components_2,
        table=force_displacement_table_2,
        dependencies = 0
    )
    ...
    connector_section = model.ConnectorSection(
        ...
        behaviorOptions=(connector_elasticity_dir1, connector_elasticity_dir2),
    ...
    return {
        ...
        'elasticity': connector_elasticity_dir2,
    }
